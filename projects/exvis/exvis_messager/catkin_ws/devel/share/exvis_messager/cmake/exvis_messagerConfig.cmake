...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'exvis_messager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zubuntu/Projects/exovis/projects/exvis/exvis_messager/catkin_ws/src/exvis_messager/${idir}'.  ${_report}")
    endif()

...
// Type of control: Torque control -----------------------------------------------
TPCANMsg CommuCAN::msgTorqueConCAN(){

	TPCANMsg message;
	message.ID = 0x47; // 71
	message.LEN = 6;
	message.MSGTYPE = PCAN_MESSAGE_STANDARD;
	message.DATA[0]= 3;	message.DATA[1]= 3;	message.DATA[2]= 3;
	message.DATA[3]= 3;	message.DATA[4]= 3;	message.DATA[5]= 3;
	return message;
}
...
// Torque set point -----------------------------------------------
TPCANMsg CommuCAN::msgStepTorqueCAN(vector<int> torque){

	TPCANMsg message;
	message.ID = 0x48; // 72
	message.LEN = 6;
	message.MSGTYPE = PCAN_MESSAGE_STANDARD;
	message.DATA[0]= torque[0];	message.DATA[1]= torque[1];	message.DATA[2]= torque[2];
	message.DATA[3]= torque[3];	message.DATA[4]= torque[4];	message.DATA[5]= torque[5];
	return message;
}

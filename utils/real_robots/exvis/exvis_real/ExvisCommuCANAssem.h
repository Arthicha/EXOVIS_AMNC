...
#ifndef EXVISCOMMUCANASSEM_H
#define EXVISCOMMUCANASSEM_H
...
class ExvisCommuCANAssem {
	public:
		ExvisCommuCANAssem(int argc,char* argv[]);
		~ExvisCommuCANAssem();
		bool runAssem();

	private:
		ExvisCommuCANROS * realRos;
		CommuCAN * comCAN;

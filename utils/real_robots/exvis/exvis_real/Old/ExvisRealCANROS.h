...
#ifndef EXVISREALCANROS_H
#define EXVISREALCANROS_H
...
class ExvisRealCANROS {
	public:
		...
		// Public Methods
		ExvisRealCANROS(int argc, char *argv[]);
		~ExvisRealCANROS();
		...
		void sendOneCycleWrite(bool oneCycleWrites);
	...
	private:
		...
		ros::Publisher oneCycleWritePub;
